...
const urlsToCache = [
    // Caminhos Absolutos
    '/ExplicaMatR/',
    '/ExplicaMatR/index.html',
    '/ExplicaMatR/manifest.json', // Adicionar o Manifest
    '/ExplicaMatR/service-worker.js', // Adicionar o próprio SW
    '/ExplicaMatR/images/icon-192x192.png', 
    '/ExplicaMatR/images/icon-512x512.png',
];
